...
public class ReplyThread extends Thread {
    ...
    @Override
    public void run() {
        synchronized (ReplyThread.class) {
            try {
                ...
                jsonReply.put("recipient", this.reply.getOriginalMessageSender());
                jsonReply.put("nameOfTheChannel", this.reply.getNameOfTheChannel());
                jsonReply.put("pingRecipient", this.reply.getPingOriginalMessageSender());
                jsonReply.put("date", this.reply.getDate().toString());
